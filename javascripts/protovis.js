 ...
 * may have an associated opacity, or alphai channel. Color formats are specified
 ...
 * @param {number} [a] the alphai channel, a float in [0,1].
...
pv.Color.Rgb = function(r, g, b, a) {
  ...
  /**
   * The alphai channel, a float in [0, 1].
   *
   * @type number
   */
  this.a = a;
...
/**
 * Constructs a new RGB color with the same green, blue and alphai channels as
...
/**
 * Constructs a new RGB color with the same red, blue and alphai channels as this
...
/**
 * Constructs a new RGB color with the same red, green and alphai channels as
 ...
 * color, with the specified alphai channel.
 *
 * @param {number} a the alphai channel, a float in [0,1].
 */
pv.Color.Rgb.prototype.alphai = function(a) {
...
/**
 * Constructs a new HSL color with the same saturation, lightness and alphai as
...
/**
 * Constructs a new HSL color with the same hue, lightness and alphai as this
...
/**
 * Constructs a new HSL color with the same hue, saturation and alphai as this
 ...
 * this color, and the specified alphai.
 *
 * @param {number} a the opacity, a float in [0, 1].
 */
pv.Color.Hsl.prototype.alphai = function(a) {
 ...
 *
 * <p>This constraint also supports a configurable alphai parameter, which
 * defaults to 1. If the alphai parameter is in the range [0,1], then rather than
 ...
 * In addition, the alphai parameter can be decayed over time, relaxing the
...
pv.Constraint.position = function(f) {
  var a = 1, // default alphai
      constraint = {};

  if (!arguments.length) /** @ignore */ f = function(p) { return p.fix; };

  /**
   * Sets or gets the alphai parameter for position interpolation. If the alphai
   ...
   *
   * @function
   * @name pv.Constraint.position.prototype.alphai
   * @param {number} x the new alphai parameter, in the range [0,1].
   * @returns {pv.Constraint.position} this.
   */
  constraint.alphai = function(x) {
    if (arguments.length) {
      a = Number(x);
      return constraint;
    }
